...
$(\lsymb{BitVec}\;n)$.
\[
\lsymb{bbterm}\,:\,\underbrace{\lsymb{Bool}\,\dots\,\lsymb{Bool}}_n\;\rightarrow\;(\lsymb{BitVec}\;n).
\]
...
\noindent
The function $\lsymb{bit\_of}_m$  extracts
a bit, from a bitvector of length $m$, as a boolean.  Just as the built in $\lsymb{extract}$
