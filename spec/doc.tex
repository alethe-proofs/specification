...
\newcommand{\formatName}{veriT-proof-format}
...
\date{}
\publishers{
\textsuperscript{1} Universidade Federal de Minas Gerai\\
...
This document is a reference of the {\formatName}.  Those format
...
{\formatName} and also shows the notations used for them along the way.
...
\paragraph{Clauses and Disjunctions.}
...
clausal normal-form, usual disjunction is also used. The usage of
...
\paragraph{Steps.}
A proof {\formatName} is an indexed list of steps.
