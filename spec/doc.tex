...
in terms of sequences of booleans, will be useful when defining the bitblasting 
proof rules. Note that:
...
\noindent
The function $\lsymb{bit\_of}_m$ extracts bit $m$-th as a boolean. Just as the built in $\lsymb{extract}$
