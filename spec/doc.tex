...
\usepackage{amsthm}
\usepackage{thmtools}
% Workarround for a 2026 bug: https://github.com/muzimuzhi/thmtools/issues/75
\makeatletter
...
%
There are two versions of the language, RARE 1.0 and RARE 2.0, and RARE 2.0 is
defined as a fragment of the \emph{Eunoia} logical framework.
%
...
%
The Alethe standard allows for steps in proof certificates to refer to rewrite
rules specified in terms of the RARE 2.0 language. Generic interfaces are
provided by the rules \proofRule{rare_rewrite}, for a single rewrite, and
\proofRule{multi_rare_rewrite}, for multiple rewrites in the same step.
