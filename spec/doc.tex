...
%
The solver then follows the state machine to print the proof
as a list of Alethe commands.
%
After printing is done, the solver prints an additional
closing parenthesis '\inlineAlethe{)}'.
%
Note that these extra parentheses are printed to ensure that the solver is SMT-LIB
compliant.  They are not part of the proof, and should only be printed when
...
The printing state machines ensure a constraint is maintained:
