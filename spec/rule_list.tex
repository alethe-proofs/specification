...
\begin{AletheXS}
$j$. & \ctxsep  & $\Gamma$  & $t_1 \ceq t_2 $ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i_1$. & \ctxsep  & $\Gamma$  & $t_1 \ceq t_2 $ & ($\dots$) \\
$i_2$. & \ctxsep  & $\Gamma$  & $t_2 \ceq t_3 $ & ($\dots$) \\
\aletheLineS
$i_n$. & \ctxsep  & $\Gamma$  & $t_n \ceq t_{n+1} $ & ($\dots$) \\
$j$. & \ctxsep  & $\Gamma$    & $t_1 \ceq t_{n+1}$ & (\currule\; $i_1$, $\dots$, $i_n$) \\
\end{AletheXS}
\end{RuleDescription}

\begin{RuleDescription}{cong}
\begin{AletheXS}
$i_1$. & \ctxsep  & $\Gamma$  & $t_1 \ceq u_1$ & ($\dots$) \\
$i_2$. & \ctxsep  & $\Gamma$  & $t_2 \ceq u_2 $ & ($\dots$) \\
\aletheLineS
$i_m$. & \ctxsep  & $\Gamma$  & $t_m \ceq u_m $ & ($\dots$) \\
$j$. & \ctxsep  & $\Gamma$  & $(f\,s_1\,\cdots\,s_n\, t_1\,\cdots\,t_m) \ceq
...
\begin{AletheXS}
$i$. & \ctxsep  & $\Gamma$  & $\varphi_1\land \cdots\land\varphi_n \ceq \psi$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep  & $\Gamma$  & $(\varphi_1\lor \cdots\lor\varphi_n) \ceq \psi$ & \currule \\
\end{AletheXS}
where $\psi$ is the transformed term.
...
\begin{AletheXS}
$i$. & \ctxsep  & $\Gamma$ & $\varphi_1\rightarrow \varphi_2 \ceq \psi$ & \currule \\
\end{AletheXS}
where $\psi$ is the transformed term.
...
\begin{AletheXS}
$i$. & \ctxsep  & $\Gamma$ & $(\varphi_1≈ \varphi_2) \ceq \psi$ & \currule \\
\end{AletheXS}
where $\psi$ is the transformed term.
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $\varphi\ceq \psi$ & \currule \\
\end{AletheXS}
where $\psi$ is the transformed term.
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $\psi \ceq \varphi_1 \circ\cdots\circ\varphi_n$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $(\lsymb{ite}\,\varphi\,t_1\,t_2) \ceq u$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $(\forall x_1, \dots, x_n. \varphi) \ceq \varphi$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $Q x_1, \dots, x_n.\,\varphi \ceq Q x_{k_1}, \dots, x_{k_m}.\,\varphi$
 & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $(t_1≈ t_2) \ceq \varphi$ & \currule \\
\end{AletheXS}
  where $\psi$ is the transformed term.
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $(t_1\, /\,  t_2) \ceq t_3$ & \currule \\
\end{AletheXS}
The possible transformations are:
\begin{itemize}
  \item $t\, /\, t ⇒ 1$
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $t_1\times\cdots\times t_n \ceq u$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $- (-t) \ceq t$ & \currule \\
\end{AletheXS}
or

\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $-t \ceq u$ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $t_1- t_2 \ceq u$ & \currule \\
\end{AletheXS}
The possible transformations are:
\begin{itemize}
    \item $t - t ⇒ 0$
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $t_1+\cdots+t_n \ceq u$ & \currule \\
\end{AletheXS}
where $u$ is either a constant or a product.
...
\begin{AletheXS}
$i$. & \ctxsep & $\Gamma$ & $t_1 \bowtie t_2 \ceq \psi$ & \currule \\
\end{AletheXS}
