...
\begin{AletheXS}
$j$. & $\Gamma$ & \ctxsep & $t_1 ≈ t_2 $ & \currule \\
\end{AletheXS}
...
\begin{AletheXS}
$i_1$. & $\Gamma$ & \ctxsep & $t_1 ≈ t_2 $ & ($\dots$) \\
$i_2$. & $\Gamma$ & \ctxsep & $t_2 ≈ t_3 $ & ($\dots$) \\
\aletheLineS
$i_n$. & $\Gamma$  & \ctxsep & $t_n ≈ t_{n+1} $ & ($\dots$) \\
$j$. & $\Gamma$  & \ctxsep & $t_1 ≈ t_{n+1}$ & (\currule\; $i_1$, $\dots$, $i_n$) \\
\end{AletheXS}
\end{RuleDescription}

\begin{RuleDescription}{cong}
\begin{AletheXS}
$i_1$. & $\Gamma$  & \ctxsep  & $t_1 ≈ u_1$ & ($\dots$) \\
$i_2$. & $\Gamma$  & \ctxsep  & $t_2 ≈ u_2 $ & ($\dots$) \\
\aletheLineS
$i_m$. & $\Gamma$  & \ctxsep  &  $t_m ≈ u_m $ & ($\dots$) \\
$j$. & $\Gamma$  & \ctxsep  & $(f\,s_1\,\cdots\,s_n\, t_1\,\cdots\,t_m) ≈
