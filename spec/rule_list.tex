...
\begin{RuleDescription}{cp_normalize}
    ...
    $$\sum_i{c_i l_i} \ge k \text{or} \left(\sum_i{c_i l_i} \ge k\right) \land \left(\sum_i{c_i l_i} \ge k\right)$$ and $\bowtie \in \{=,>,<,\ge,\le\}$.
    ...
    \begin{itemize}
        ...
        \item $-c_i l_i + \psi \ge k \Rightarrow c_i (1 - l_i) + \psi \ge k + c_i$
