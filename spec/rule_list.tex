...
This rule refers to the application of the RARE rewrite rule 
$\lsymb{rewrite\_rule}$, which should justify the conclusion $t ≈ s$. Recall that 
a RARE rewrite rule is defined using a domain-specific language, called RARE, 
which is introduced in section \ref{sec:alethe:rare_rules}. We assume that the 
producer of the Alethe proof certificate has at its disposal an arbitrary set of 
...
wrapped into a list, built with $\lsymb{@list}$. In this
