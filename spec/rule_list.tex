...
\end{AletheXS}
  ...
  n\} \land j\notin \{k_1, \dots, k_m\}\}$ then $x$ is not free in $\varphi$.
\end{RuleDescription}
...
\begin{RuleDescription}{bitblast_shl}
\begin{AletheX}
$i$. & \ctxsep & $\bvshl{x}{d} ≈ A_1$ & \currule \\
\end{AletheX}
Where $d$ is the \emph{width of the shift distance}. For a bitvector $x$ of
width $n$, the term $A_1$ is:
\begin{align*}
\bbterm\;& (\lsymb{ite} \, (0 \ge d) (\bitof{0 - d}\ x) \, \bot) \\
         & \ldots \\
         & (\lsymb{ite} \, (n - 1 \ge d) (\bitof{(n - 1) - d}\ x) \, \bot) \\
\end{align*}
...
\begin{AletheX}
$i$. & \ctxsep & $\bvshl{x}{d} ≈ A_2$ & \currule \\
\end{AletheX}
with $A_2 := \bbterm\ (\lsymb{ite} \, (0 \ge d) (x_{0 - d}) \, \bot)\
             \ldots\  (\lsymb{ite} \, ((n -1) \ge d) (x_{(n - 1) - d}) \, \bot)$.
\end{RuleDescription}

\begin{RuleDescription}{bitblast_lshr}
\begin{AletheX}
$i$. & \ctxsep & $\bvlshr{x}{d} ≈ A_1$ & \currule \\
\end{AletheX}
Where $d$ is the \emph{width of the shift distance}. For a bitvector $x$ of
width $n$, the term $A_1$ is:
\begin{align*}
\bbterm\;& (\lsymb{ite} \; (0 < n - d) \; (\bitof{0 + d}\ x) \, \bot) \\
         & \ldots \\
         & (\lsymb{ite} \; (n - 1 < n - d) \; (\bitof{(n - 1) + d}\ x) \, \bot) \\
\end{align*}
...
\begin{AletheX}
$i$. & \ctxsep & $\bvlshr{x}{d} ≈ A_2$ & \currule \\
\end{AletheX}
with $A_2 := \bbterm\ (\lsymb{ite} \, (0 \ge d) (x_{0 - d}) \, \bot)\
             \ldots\  (\lsymb{ite} \, ((n -1) \ge d) (x_{(n - 1) - d}) \, \bot)$.
\end{RuleDescription}

\begin{RuleDescription}{bitblast_ashr}
\begin{AletheX}
$i$. & \ctxsep & $\bvashr{x}{d} ≈ A_1$ & \currule \\
\end{AletheX}
Where $d$ is the \emph{width of the shift distance}. For a bitvector $x$ of
width $n$, the term $A_1$ is:
\begin{align*}
\bbterm\;& (\lsymb{ite} \; (0 \ge d) \; (\bitof{0 - d}\ x) \, (\bitof{n - 1}\ x)) \\
         & \ldots \\
         & (\lsymb{ite} \; (n - 1 \ge d) \; (\bitof{(n - 1) - d}\ x) \, (\bitof{n - 1}\ x)) \\
\end{align*}

Where, for a bitvector $x$ using two's complement encoding, $(\bitof{n - 1}\ x)$
is the boolean codification of $x$'s sign bit. That is, we replicate its sign bit.
...
\begin{AletheX}
$i$. & \ctxsep & $\bvashr{x}{d} ≈ A_2$ & \currule \\
\end{AletheX}
with $A_2 := \bbterm\ (\lsymb{ite} \, (0 \ge d) (x_{0 - d}) \, x_{n - 1})\
             \ldots\  (\lsymb{ite} \, ((n -1) \ge d) (x_{(n - 1) - d}) \, x_{n - 1})$.
\end{RuleDescription}

\begin{RuleDescription}{bitblast_div}
\begin{AletheX}
$i$. & \ctxsep & $\bvdiv{num}{den} ≈ A_1$ & \currule \\
\end{AletheX}
For bitvectors $num$ and $den$ of width $n$, and let $zero$ represent a bitvector 
of width $n$ whose bits are all 0. Then, the term $A_1$ is:
\begin{align*}
A_1 & =\left\{ zero, \mathrm{if \; num \; = \;zero} \right.\\[3ex] \\
\end{align*}
