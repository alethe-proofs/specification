...
in both terms. The rule applies to ACI operators (that is, those that satisfy
...
In particular:
\begin{itemize}
  \item Logical operations: $\vee$, $\wedge$.
  \item Bit vectors: bvor, bvand, bvadd, bvmul, concat.
  \item Arithmetic: - (binary substraction), +, *.
  \end{itemize}
