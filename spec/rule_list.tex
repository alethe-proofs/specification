...
Finally, the sum of the obtained inequalities should result in a trivial 
contradiction. The sum:
\[
...
$t_i$ of $l_k$, and $d^k$ is the constant $d$ of $l_k$. The relation $\bowtie'$
