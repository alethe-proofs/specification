...
% I cannot find the exact notation P[x_1\mapsto t_1, \dots, x_n\mapsto t_n] in previous
% chapters. Following 1.1 Notations, it looks like the notation should be something
% like [x_1\mapsto t_1, \dots, x_n\mapsto t_n](P). Or am I confused?
\begin{AletheX}
$i$. & \ctxsep &
