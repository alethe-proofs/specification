...
\begin{RuleDescription}{pbblast_pbbconst}
    ...
    \begin{AletheX}
        $i$. & \ctxsep & $\left(b \approx \lsymb{pbbT}\; \textbf{match}(b_0) \dots \textbf{match}(b_{n-1}) \right)$ & (\currule) \\
    \end{AletheX}
    \noindent
...
\begin{RuleDescription}{pbblast_bvxor}
    ...
    \begin{AletheX}
        $i$. & \ctxsep & $(\lsymb{bvxor}\ x\ y) \approx \lsymb{pbbT}\; c_0 \dots c_{n-1}$ & (\currule) \\
    \end{AletheX}
...
\begin{RuleDescription}{pbblast_bvand}
    ...
    \begin{AletheX}
        $i$. & \ctxsep & $(\lsymb{bvand}\ x\ y) \approx \lsymb{pbbT}\; c_0 \dots c_{n-1}$ & (\currule) \\
    \end{AletheX}
