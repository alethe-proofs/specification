...
\DeclareMathOperator{\ceq}{\pmb{\approx}}
...
% Bitvector-related defs.
% Abstract syntax
% Type terms
\newcommand\bitvec[1]{\ensuremath{\lsymb{BitVec} \; #1}}
% Constructors, query functions, etc.
\newcommand\bbterm[0]{\ensuremath{\lsymb{bbterm}}}
\newcommand\bitof[1]{\ensuremath{\lsymb{bit\_of}_{#1}}}
\newcommand\bvsize[0]{\ensuremath{\lsymb{bvsize}}}
\newcommand\bv[2]{\ensuremath{\lsymb{bv}_{#1}^{#2}}}
\newcommand\bvextract[2]{\ensuremath{\lsymb{extract} \; {#1} \; {#2}}}
\newcommand\bvconcat[2]{\ensuremath{\lsymb{concat} \; {#1} \; {#2}}}
\newcommand\bvsext[2]{\ensuremath{\lsymb{bvsextend} \; {#1} \; {#2}}}
\newcommand\bveq[2]{\ensuremath{\lsymb{bveq} \; {#1} \; {#2}}}
\newcommand\bvult[2]{\ensuremath{\lsymb{bvult} \; {#1} \; {#2}}}
\newcommand\bvslt[2]{\ensuremath{\lsymb{bvslt} \; {#1} \; {#2}}}
\newcommand\bvadd[2]{\ensuremath{\lsymb{bvadd} \; {#1} \; {#2}}}
\newcommand\bvmult[2]{\ensuremath{\lsymb{bvmult} \; {#1} \; {#2}}}
\newcommand\bvneg[1]{\ensuremath{\lsymb{bvneg} \; {#1}}}
\newcommand\bvand[2]{\ensuremath{\lsymb{bvand} \; {#1} \; {#2}}}
\newcommand\bvor[2]{\ensuremath{\lsymb{bvor} \; {#1} \; {#2}}}
\newcommand\bvxor[2]{\ensuremath{\lsymb{bvxor} \; {#1} \; {#2}}}
\newcommand\bvxnor[2]{\ensuremath{\lsymb{bvxnor} \; {#1} \; {#2}}}
\newcommand\bvnot[1]{\ensuremath{\lsymb{bvnot} \; {#1}}}
\newcommand\bvshl[2]{\ensuremath{\lsymb{bvshl} \; {#1} \; {#2}}}
\newcommand\bvlshr[2]{\ensuremath{\lsymb{bvlshr} \; {#1} \; {#2}}}
\newcommand\bvashr[2]{\ensuremath{\lsymb{bvashr} \; {#1} \; {#2}}}
\newcommand\bvdiv[2]{\ensuremath{\lsymb{bvdiv} \; {#1} \; {#2}}}
% Concrete syntax
\newcommand\cbbterm[0]{\inlineAlethe{@bbterm}}
% NOTE: not adding the parameters to avoid spacing problems 
% when trying to typeset just the names of the functions.
\newcommand\cbitof[0]{\inlineAlethe{@bit_of}}
\newcommand\cbvsize[0]{\inlineAlethe{@bvsize}}
\newcommand\cbv[0]{\inlineAlethe{@bv}}
