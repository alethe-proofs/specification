...
\declaretheorem[name=Rule,style=proof-rule-style,sibling=ProofRuleCounter]{innerRule}
...
\begin{innerRule}[\detokenize{#1}]\label{rule:#1}
...
\newtheorem{RuleExample}{Example}[innerRule]
