...
\newcommand{\ruleType}[1]{%
	\microtypesetup{tracking=false}\textsf{#1}\microtypesetup{tracking=true}%
}
\def\proofRule#1{\hyperref[rule:\detokenize{#1}]{\ruleType{\detokenize{#1}}}}
...
\setlength{\arrayrulewidth}{0.8pt}
\addtolength{\tabcolsep}{-4pt}
\begin{xltabular}{\linewidth}{l r c Y l}
  \BODY
\end{xltabular}
\addtolength{\tabcolsep}{+4pt}
}
...
applications.  This is discussed in the Section~\ref{sec:alethe:semantic}.

\begin{example}[reference=ex:ti:ctx-abstract]
...
\begin{example}[reference=ex:ti:ctx-concrete]
